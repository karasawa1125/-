...
<html>
  <head>
    ...
    <title>Sanctuary | アカウント内容を変更する</title>
    ...
    <div class="sub_page">
      <h1>アカウント内容を変更する</h1>
        <form method="post" action="../controller/UpdateController.php">
          <p>お名前</p>
          <input type="name" name="name" value="<?php print($account["name"]); ?>"><br>
          <p>ID</p>
          <input type="text" name="login_id" value="<?php print($account["login_id"]); ?>"><br>
          <p>メールアドレス</p>
          <input type="mail" name="mail" value="<?php print($account["mail"]); ?>"><br>
          <p>パスワード</p>
          <input type="password" name="password" value="<?php print($account["password"]); ?>"><br>
